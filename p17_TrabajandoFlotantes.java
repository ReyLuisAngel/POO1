...
public class p17_TrabajandoFlotantes {
    ...
    System.out.println(String.format("num1 alineado en formato flotante alineado: %8.2f",num1));
    System.out.println(String.format("num1 alineado en formato flotante alineado: %12.2f",num2));
