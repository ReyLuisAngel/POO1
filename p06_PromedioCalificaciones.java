...
public class p06_PromedioCalificaciones {
    public static void main(String[] args) {
        ...
        System.out.println("Calculando el promedio de tres calificaciones, calculando tambien la mayor y la menor calificacion.\n");
        ...
        System.out.printf("\nLas calificaciones ingresadas son: %.2f, %.2f,%.2f\n",cal1,cal2,cal3);
